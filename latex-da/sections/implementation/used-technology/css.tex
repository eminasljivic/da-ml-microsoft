...
Da die Funktionalitäten von \gls{css} sehr eingeschränkt sind, wird oftmals als Weiterentwicklung \gls{scss} genutzt. Dies ermöglicht das Vereinfachen von Regeln und macht diese generell überschaubarer.
